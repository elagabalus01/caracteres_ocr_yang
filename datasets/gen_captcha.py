...
def _gen_captcha(img_dir, num_per_image, n, width, height, choices):
    ...
    permutaciones=list(itertools.permutations(choices, num_per_image))
    shuffle(permutaciones)
    permutaciones=permutaciones[:69534]
    ...
    for _ in range(n):
        for i in permutaciones:
            ...
            permutations_count=permutations_count+1
